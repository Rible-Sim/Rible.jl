function prisms(;
    ...
    # display(sharing)
    # cnt = RB.Connectivity(rbs,sharing)
    ...
    cnt = hasplate ? RB.PresFreeConnectivity(rbs, apparatuses) : RB.Connectivity(rbs, apparatuses)
    @show cnt.bodyid2sys_intrinsic_cstr_idx
