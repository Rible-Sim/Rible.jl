...
a1 = norm(rb1prop.aps[3] - rb1prop.aps[2])
a2 = norm(rb2prop.aps[3] - rb2prop.aps[1])
β1 = get_angle(rb1prop.aps[3] - rb1prop.aps[2],rb1prop.aps[4] - rb1prop.aps[2])
β2 = get_angle(rb2prop.aps[4] - rb2prop.aps[1],rb2prop.aps[3] - rb2prop.aps[1])
...
ΔL = 0.0
# k = 800.0
function nlsolvek(θ0,a1,a2,k,ΔL)
    function L02k(L0)
        f_static = make_f_static(θ0,a1,a2,k,L0,ΔL)
        k = ForwardDiff.derivative(f_static,0.0)
    end
    nlsolve(L02k,0.0)
end
nlsolvek(θ0,a1,a2,k,ΔL)
# f_static(-1)
