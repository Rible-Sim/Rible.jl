...
function nextstate(tr,x_k,a,tm;dt=0.01,ftol=1e-14)
    ...
    TR.set_new_initial!(tr,q_k,q̇_k)
    prob = TR.DyProblem(dynamics(tr,a),tr,(0.0,tm))
    intor = TR.solve!(tr,prob,TR.Zhong06();dt,ftol,exception=false,progress=false)
