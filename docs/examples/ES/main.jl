...
μ1 = TR.inverse_for_restlength(tower3dbot1,tower3dbot1;gravity=true)
...
newbridge_tag_deploy = bridge3d(;
    k,
)

TR.set_restlen!(newbridge_tag_deploy.tg,μ_tag)
TR.update!(newbridge_tag_deploy.tg)
TR.get_cables_tension(newbridge_tag_deploy.tg) |> extrema
TR.check_static_equilibrium_output_multipliers(newbridge_tag_deploy.tg;gravity=true)
TR.undamped_eigen(newbridge_tag_deploy.tg;gravity=true)
...
k,μ=TR.optimize_for_stiffness_and_restlen(newlander;gravity=false)
k,μ
