...
jac_singularity_check(tg)   #运行到这一步报warningSystem's Jacobian is singular: rank(A(q))=15<16
                                # @ TensegrityRobots D:\TensegrityRobots.jl\src\tensegrity.jl:475
...
@code_lowered for rbid in tg.mvbodyindex
    pindex = body2q[rbid]
