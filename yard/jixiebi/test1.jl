...
cluster_dampers = [RB.ClusterDistanceSpringDampers(cluster_segs) for _ in 1:ncluster]
...
cluster = RB.connect_clusters(bodies, cluster_sps, cluster_segs, connecting_cluster_matrix)
cables = RB.connect_spring(bodies, spring_dampers; cm=connecting_matrix)
