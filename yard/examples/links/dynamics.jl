...
displacement_cstr_errors, velocity_cstr_errors = compute_contraint_error(linkn_undamped)
plt.plot(displacement_cstr_errors)
plt.plot(velocity_cstr_errors)
